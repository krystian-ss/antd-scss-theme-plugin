...
function importsToResolve(url) {
  const request = _loaderUtils2.default.urlToRequest(url);
  // Keep in mind: ext can also be something like '.datepicker' when the true extension is omitted and the filename contains a dot.
  // @see https://github.com/webpack-contrib/sass-loader/issues/167
  const ext = _path2.default.extname(request).toLowerCase();
  ...
  const dirname = _path2.default.dirname(request);
  const basename = _path2.default.basename(request);
...
exports.default = importsToResolve;
